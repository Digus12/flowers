...
public class Flower {
    ...
    public static void main(String args[]) {
        ...
        Color[]  palette = { StdDraw.RED, StdDraw.BLUE, StdDraw.CYAN,
                StdDraw.DARK_GRAY, StdDraw.ORANGE, StdDraw.GREEN,
                StdDraw.BOOK_LIGHT_BLUE, StdDraw.MAGENTA, StdDraw.ORANGE,
                StdDraw.PINK, StdDraw.RED, StdDraw.BOOK_RED, StdDraw.YELLOW };
        //
        ...
        flower(palette, .5, .5, .3, .3, 0);
        flower(palette, .8, .3, .3, .3, 0);
        flower(palette, .2, .3, .3, .3, 0);
    }
}